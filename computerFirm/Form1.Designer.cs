...
namespace computerFirm
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.поставщикиTableAdapter = new computerFirm.ComputerFirmDataSetTableAdapters.ПоставщикиTableAdapter();
            this.продукцияBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.продукцияTableAdapter = new computerFirm.ComputerFirmDataSetTableAdapters.ПродукцияTableAdapter();
            this.списокУслугBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.список_услугTableAdapter = new computerFirm.ComputerFirmDataSetTableAdapters.Список_услугTableAdapter();
            ...
            this.работникиBindingSource1.DataSource = this.computerFirmDataSet;
            // 
            // computerFirmDataSet
            // 
            ...
            // 
            // computerFirmDataSetBindingSource
            // 
            this.computerFirmDataSetBindingSource.DataSource = this.computerFirmDataSet;
            this.computerFirmDataSetBindingSource.Position = 0;
            // 
            ...
            // 
            this.updateTableStringBtn.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
        ...
        private ComputerFirmDataSetTableAdapters.ПоставщикиTableAdapter поставщикиTableAdapter;
        private System.Windows.Forms.BindingSource продукцияBindingSource;
        private ComputerFirmDataSetTableAdapters.ПродукцияTableAdapter продукцияTableAdapter;
        private System.Windows.Forms.BindingSource списокУслугBindingSource;
        private ComputerFirmDataSetTableAdapters.Список_услугTableAdapter список_услугTableAdapter;
